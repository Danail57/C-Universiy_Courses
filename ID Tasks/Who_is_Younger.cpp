...
int main()
{
	...
	/*В ЕГН първите 6 цифри са YYMMDD, но ММ не е
	просто месец – то показва и в кой век е роден 
	човекът:
ММ (число)	Век	Реален  месец
  01–12	    1900–1999	01–12
  21–32	    1800–1899	01–12
  41–52	    2000–2099	01–12

  Тоест, ако виждаме, че месецът е > 40 → човекът е роден след 2000 г., 
и трябва да намалим 40, за да получим реалния месец.*/
