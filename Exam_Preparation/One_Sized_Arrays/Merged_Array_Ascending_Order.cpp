/* Дадени са едномерните масиви a с m елемента
и b с n елемента. Елементите им са подредени
в ненамаляващ ред.
Да се слеят двата масива в масив d с m+n
елемента, също подреден в нарастващ ред. */
