...
// Да се състави рекурсивна програма, която намира 
// срeдноаритметичното r създава нов масив 
// а0, а1,...,аn-1, като стойността на 
// аi  е равна на разликата между 
// средно-аритметичното на нечетните цифри
...
void create_difference_array(int A[], int B[], double C[], int n, int i = 0)
{
	if (i == n)
		return;
	...
	create_difference_array(A, B, C, n, i + 1);
}
...
int main()
{
	...
	create_difference_array(A, B, C, n);
